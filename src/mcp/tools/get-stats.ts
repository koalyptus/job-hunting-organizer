...
export function registerGetStats(server: McpServer): void {
  server.registerTool('get_stats', { description: 'Compute campaign statistics: counts by status, role, site, employment type, funnel, and this-month delta', inputSchema: GetStatsInput }, async (args) => {
              try {
